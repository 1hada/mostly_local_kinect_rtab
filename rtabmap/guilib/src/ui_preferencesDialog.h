...
"when using the file type, logs are saved in LogRtabmap.txt (located in the working directory).", Q_NULLPTR));
        ...
        label_565->setText(QApplication::translate("preferencesDialog", "Dual Mode (D400+T265): Odometry is computed by T265 and RGB-D frames are from D400.", Q_NULLPTR));
        label_549->setText(QApplication::translate("preferencesDialog", "Stream width.", Q_NULLPTR));
        ...
        label_550->setText(QApplication::translate("preferencesDialog", "Stream height.", Q_NULLPTR));
        label_551->setText(QApplication::translate("preferencesDialog", "Stream rate.", Q_NULLPTR));
        ...
        label_558->setText(QApplication::translate("preferencesDialog", "Use IR for RGB image (odometry may be better)", Q_NULLPTR));
        ...
        label_600->setText(QApplication::translate("preferencesDialog", "RGB camera resolution", Q_NULLPTR));
        ...
        comboBox_stereoZed_quality->insertItems(0, QStringList()
         ...
         << QApplication::translate("preferencesDialog", "MEDIUM", Q_NULLPTR)
         << QApplication::translate("preferencesDialog", "QUALITY", Q_NULLPTR)
         << QApplication::translate("preferencesDialog", "ULTRA", Q_NULLPTR)
        );
        label_306->setText(QApplication::translate("preferencesDialog", "Filtering value for the disparity map (and by extension the depth map). A lower value means more confidence and precision (but less density), an upper value reduces the filtering (more density, less certainty).", Q_NULLPTR));
        ...
        label_570->setText(QApplication::translate("preferencesDialog", "[SDK3] Threshold to reject depth values based on their textureness confidence. A lower value means more confidence and precision (but less density). An upper value reduces filtering (more density, less certainty.).", Q_NULLPTR));
        ...
        label_563->setText(QApplication::translate("preferencesDialog", "Publish inter IMU messages from the camera. IMU received between images will be published as separate topic.", Q_NULLPTR));
...
"If set to false, classic RTAB-Map loop closure detection is done using only images and without any metric information.", Q_NULLPTR));
        ...
        label_scanMatching_2->setText(QApplication::translate("preferencesDialog", "When loading a database, ignore last saved localization pose from previous session. If true, RTAB-Map won't assume it is restarting from the same place than where it shut down previously.", Q_NULLPTR));
        ...
        label_scanMatching_6->setText(QApplication::translate("preferencesDialog", "Save scan matching IDs in link's user data.", Q_NULLPTR));
        checkBox_localSpaceScanMatchingIDsSaved->setText(QString());
        label_scanMatching_8->setText(QApplication::translate("preferencesDialog", "Maximum angle for visual proximity detection.", Q_NULLPTR));
        localDetection_angle->setSuffix(QApplication::translate("preferencesDialog", " deg", Q_NULLPTR));
        label_space3_4->setText(QApplication::translate("preferencesDialog", "Maximum paths compared (from the most recent). 0 means no limit.", Q_NULLPTR));
        label_space3_8->setText(QApplication::translate("preferencesDialog", "Maximum neighbor nodes compared on each path. Set to 0 to disable merging close scans.", Q_NULLPTR));
        label_scanMatching_13->setText(QApplication::translate("preferencesDialog", "Use odometry as motion guess for visual proximity detection.", Q_NULLPTR));
        ...
        odom_strategy->insertItems(0, QStringList()
         ...
         << QApplication::translate("preferencesDialog", "ORB SLAM 2", Q_NULLPTR)
        ...
        groupBox_odomORBSLAM2->setTitle(QApplication::translate("preferencesDialog", "ORB SLAM 2", Q_NULLPTR));
        label_412->setText(QApplication::translate("preferencesDialog", "<html><head/><body><p>ORB SLAM 2: <a href=\"https://github.com/raulmur/ORB_SLAM2\"><span style=\" text-decoration: underline; color:#0000ff;\">https://github.com/raulmur/ORB_SLAM2</span></a></p><p>Tracking and local mapping from ORB SLAM 2 is done but loop closure detection is disabled, using RTAB-Map loop closure detection instead. See ORB panel for ORB parameters (pyramid scale and number of pyramids). See FAST panel for FAST parameters (init and min thresholds). Vis/MaxFeatures (see Visual Registration panel) is used as the number of ORB features extracted.<br/></p></body></html>", Q_NULLPTR));
        doubleSpinBox_OdomORBSLAM2Bf->setSuffix(QApplication::translate("preferencesDialog", " m", Q_NULLPTR));
        ...
        toolButton_OdomORBSLAM2VocPath->setText(QApplication::translate("preferencesDialog", "...", Q_NULLPTR));
...
"Lower the ratio -> higher the precision.", Q_NULLPTR));
        ...
        label_422->setText(QApplication::translate("preferencesDialog", "<html><head/><body><p>libpointmatcher: <a href=\"https://github.com/ethz-asl/libpointmatcher\"><span style=\" text-decoration: underline; color:#0000ff;\">https://github.com/ethz-asl/libpointmatcher</span></a></p><p>libpointmatcher is a modular library implementing the Iterative Closest Point (ICP) algorithm for aligning point clouds. It has applications in robotics and computer vision. When enabled, libpointmatcher is used for ICP registration instead of PCL's implementation.</p><p>Below we can set a <a href=\"https://github.com/ethz-asl/libpointmatcher/blob/master/doc/Configuration.md\"><span style=\" text-decoration: underline; color:#0000ff;\">configuration file</span></a> (*.yaml) used by libpointmatcher. Note that data filters set for libpointmatcher are done after filtering done by rtabmap (i.e., voxel filtering or downsampling above), so make sure to disable those in rtabmap if you want to use only those from libpointmatcher. Maximum iterations, epsilon and max correspondence distance parameters are al"
                        "so ignored if configuration file is set.<br/></p></body></html>", Q_NULLPTR));
        ...
        label_446->setText(QApplication::translate("preferencesDialog", "TrimmedDistOutlierFilter/ratio: For convenience when configuration file is not set. For kinect-like point cloud, use 0.65.", Q_NULLPTR));
